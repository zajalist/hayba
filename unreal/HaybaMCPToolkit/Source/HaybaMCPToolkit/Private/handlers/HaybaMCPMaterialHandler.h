...
private:
    ...
    FHaybaHandlerResult MatSetComment(const TSharedPtr<FJsonObject>& P);
    ...
    FHaybaHandlerResult MatCompile(const TSharedPtr<FJsonObject>& P);
    FHaybaHandlerResult MatValidate(const TSharedPtr<FJsonObject>& P);
    FHaybaHandlerResult MatDisconnect(const TSharedPtr<FJsonObject>& P);
};
