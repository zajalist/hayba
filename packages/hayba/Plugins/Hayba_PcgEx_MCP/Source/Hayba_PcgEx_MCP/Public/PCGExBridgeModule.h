...
class FPCGExBridgeTcpServer;
class FPCGExBridgeCommandHandler;

class FPCGExBridgeModule : public IModuleInterface
{
public:
    ...
    /** Send a TCP command and call Callback on game thread with the response */
    void SendTcpCommand(
        const FString& Cmd,
...
private:
    ...
    TSharedPtr<FPCGExBridgeTcpServer> TcpServer;
