...
{
	CommandMap.Add(TEXT("ping"), &FHaybaMCPCommandHandler::Cmd_Ping);
	CommandMap.Add(TEXT("list_node_classes"), &FHaybaMCPCommandHandler::Cmd_ListNodeClasses);
	CommandMap.Add(TEXT("get_node_details"), &FHaybaMCPCommandHandler::Cmd_GetNodeDetails);
	CommandMap.Add(TEXT("list_pcg_assets"), &FHaybaMCPCommandHandler::Cmd_ListPCGAssets);
	CommandMap.Add(TEXT("export_graph"), &FHaybaMCPCommandHandler::Cmd_ExportGraph);
	CommandMap.Add(TEXT("create_graph"), &FHaybaMCPCommandHandler::Cmd_CreateGraph);
...
FString FHaybaMCPCommandHandler::Cmd_Ping(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
	...
	UE_LOG(LogHaybaMCPCmd, Log, TEXT("Ping command processed"));
	return MakeOkResponse(Id, Data);
}

FString FHaybaMCPCommandHandler::Cmd_ListNodeClasses(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
...
TArray<UClass*> FHaybaMCPCommandHandler::FindPCGExNodeClasses() const
{
...
void FHaybaMCPCommandHandler::GetPinInfo(const UClass* SettingsClass, TArray<TSharedPtr<FJsonValue>>& OutInputs, TArray<TSharedPtr<FJsonValue>>& OutOutputs) const
{
...
FString FHaybaMCPCommandHandler::Cmd_GetNodeDetails(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
    FString ClassName;
...
FString FHaybaMCPCommandHandler::Cmd_ListPCGAssets(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
...
FString FHaybaMCPCommandHandler::Cmd_ExportGraph(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
    FString AssetPath;
...
FString FHaybaMCPCommandHandler::Cmd_CreateGraph(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
    FString Name;
...
FString FHaybaMCPCommandHandler::Cmd_ValidateGraph(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
    const TSharedPtr<FJsonObject>* GraphObj;
    if (!Params->TryGetObjectField(TEXT("graph"), GraphObj) || !GraphObj->IsValid())
    {
...
TArray<TSharedPtr<FJsonValue>> FHaybaMCPCommandHandler::ValidateGraphJson(const TSharedPtr<FJsonObject>& Graph) const
{
    TArray<TSharedPtr<FJsonValue>> Errors;
...
FString FHaybaMCPCommandHandler::Cmd_ExecuteGraph(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
    FString AssetPath;
    if (!Params->TryGetStringField(TEXT("assetPath"), AssetPath))
    {
...
FString FHaybaMCPCommandHandler::Cmd_WizardChat(const TSharedPtr<FJsonObject>& Params, const FString& Id)
{
