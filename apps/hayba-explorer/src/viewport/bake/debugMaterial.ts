...
const VERT: string = [
  ...
  "  /* Flat stack mode (uStackMode 2) renders an UNdisplaced sphere so the",
  "     map reads clean; relief (0) + draped (1) extrude as before. */",
  "  float dispGain = (uStackMode > 1.5) ? 0.0 : 1.0;",
...
const FRAG: string = [
  ...
  "uniform float uStackMode;    /* 0 relief (today) | 1 draped | 2 flat     */",
