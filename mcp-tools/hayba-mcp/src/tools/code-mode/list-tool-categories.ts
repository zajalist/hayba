...
const DOMAINS: ReadonlyArray<{ domain: string; command_count: number; commands: string[] }> = [
  ...
  },
  {
    domain: 'foliage',
    command_count: 4,
    commands: ['foliage_add_instance', 'foliage_remove_instances', 'foliage_list_types', 'foliage_paint_at'],
  },
  {
    domain: 'spline',
    command_count: 5,
    commands: ['spline_create', 'spline_add_point', 'spline_set_point', 'spline_remove_point', 'spline_get_info'],
  },
  { domain: 'wp', command_count: 3, commands: ['wp_get_cells', 'wp_load_cell', 'wp_get_streaming_state'] },
  {
    domain: 'ism',
    command_count: 4,
    commands: ['ism_create_actor', 'ism_add_instance', 'ism_add_instances', 'ism_clear_instances'],
  },
  {
    domain: 'physics',
    command_count: 3,
    commands: ['physics_set_simulate', 'physics_set_collision_profile', 'physics_add_impulse'],
  },
