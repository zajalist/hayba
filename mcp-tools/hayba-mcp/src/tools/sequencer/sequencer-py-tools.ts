...
function seqCameraCutScript(p: SeqCameraCutParams): string {
  return [
    ...
    '    except Exception:',
    '        try: unreal.MovieSceneSectionExtensions.set_start_frame_seconds(section, _start); unreal.MovieSceneSectionExtensions.set_end_frame_seconds(section, _end)',
    '        except Exception: pass',
...
export const seqCameraCutDescriptor: PyToolDescriptor<typeof seqCameraCutSchema.shape> = {
  ...
  cost: 'medium',
  returns: '{ok, camera_guid, start_frame, end_frame, start_seconds, end_seconds, dry_run?}',
